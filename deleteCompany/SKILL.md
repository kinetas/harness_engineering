---
name: deleteCompany
description: 배포 전 정리 — AI 운영 파일을 삭제하고 README.md를 자동 생성합니다.
---
...
## Step 2 — Ask for Additional README Sections

Ask the user:

> "README.md에 추가로 남기고 싶은 항목이 있으신가요?
...
Generate `README.md` in the project root with these sections:
...
- Add any sections the user specified in Step 2
