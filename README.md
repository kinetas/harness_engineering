...
| `/newTask [요청]` | 새 작업 요청 — 단순 요청은 Manager AI 1개, 복잡한 요청은 DAG 기반 세그먼트 분할 후 Manager AI 병렬 위임 |
...
`/projectStart`, `/changeStart`, `/newTask`(복잡한 요청) 실행 시 Boss AI가 아래 순서로 세그먼트를 구성합니다.
